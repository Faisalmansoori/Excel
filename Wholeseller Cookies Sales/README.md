...
- Strong between `Revenue`<->`Gross Profit` r = (+1.00)
- Weak between `Units Sold`<->`Cost/profit per product` r = (-0.02)
...
The analysis reveals that the **Wholesale Cookies** business is highly profitable, generating approximately $2.72 million in profit from $4.69 million in revenue. Chocolate Chip Cookies are the primary revenue driver and should remain a strategic focus. Retailers 3 and 4 contribute the largest share of sales and profits, making them key business partners. Overall, the company demonstrates strong market demand and sustainable profitability.

---

<h2><a class="anchor" id="future-work"></a>🚀 Future Work</h2>

<b>Several enhancements can further increase the business value of this analysis:</b>
